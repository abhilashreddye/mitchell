...
public class VehicleInfoType {
    ...
    @XmlTransient
    @Column(name = "LicPlateExpDate")
    @Temporal(TemporalType.DATE)
    protected Date licPlateExpDateDate;
	...
	public Date getLicPlateExpDateDate() {
		return licPlateExpDateDate;
	}

	public void setLicPlateExpDateDate(Date licPlateExpDateDate) {
		this.licPlateExpDateDate = licPlateExpDateDate;
	}
	...
	public void setKey(VehicleKey key) {
		this.key = key;
	}
